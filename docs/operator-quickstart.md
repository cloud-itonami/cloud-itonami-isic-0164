# Operator Quickstart — Seed Processing for Propagation Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0164** (`cloud-itonami-isic-0164`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0164.git
cd cloud-itonami-isic-0164
```
...
- Blueprint governor key: `seedops-governor`
- Likely source path: `seedops.governor.cljc`

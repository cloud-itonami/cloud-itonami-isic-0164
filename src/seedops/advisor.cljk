(ns seedops.advisor
  "SeedOpsAdvisor -- the LLM/decision-maker that proposes operations.

  The advisor operates purely at the proposal level; the Governor
  (seedops.governor) independently validates all proposals against
  physical/quality safety rules before any action is committed.
